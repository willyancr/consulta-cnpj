...
/**
 * Biblioteca nativa de ícones SVG limpos e estilizados com Tailwind
 * Atende estritamente à restrição: "Não usar bibliotecas externas de ícones (apenas Tailwind e React)"
 */
...
export function CompareIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
